...
public class SudokuTest {
    ...
    public void testSudokuValidator() {
        ...
        assertTrue(SudokuValidator.isValidSudoku(board2));

        // 5-ös duplán oszlopban
        int[][] board3 = {
                {5, 3, 4, 6, 7, 8, 9, 1, 2},
                {6, 7, 2, 1, 9, 5, 3, 4, 8},
                {1, 9, 8, 3, 4, 2, 5, 6, 7},
        ...
        assertFalse(SudokuValidator.isValidSudoku(board3));

        // 5-ös duplán a felső bal 3x3-ban
        int[][] board4 = {
                {5, 3, 0, 0, 7, 0, 0, 0, 0},
                {6, 5, 0, 1, 9, 5, 0, 0, 0},
                {0, 9, 8, 0, 0, 0, 0, 6, 0},
